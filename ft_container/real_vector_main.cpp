...
int main() {
	...
	std::cout << "----------------------- Constructor " << std::endl;
	{
		...
		std::vector<int> ft3(ft2.begin() + 1, ft2.end() - 1);
	...
	{
		std::vector<int> ft1(3, 100);
		std::vector<int>::iterator ft_iter;
	...
	{
		std::vector<int> ft1(3, 1);
		std::vector<int> ft2(3, 99);
	...
	{
		std::vector<int> ft1(5, 5);
		std::vector<int> ft2(5, 5);
		...
		std::cout << "  [ operator < test 2 ]" << std::endl;
		std::vector<std::string> ft3(3, "a");
		std::vector<std::string> ft4(2, "a");
