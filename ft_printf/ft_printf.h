...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/03/10 20:25:00 by sjin              #+#    #+#             */
/*   Updated: 2021/03/10 21:00:35 by sjin             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			flag_width_precision
				(char *str, t_options *op, va_list ap, int i);

int				width_print_char(int width, int len, int zero);
int				width_print_str(char **str, t_options *op, int str_len);
int				nbr_2(t_options *op,
				unsigned long long nbr, int len, char ***new_nbr);
int				nbr_1(t_options *op,
				unsigned long long nbr, int len, char ***new_nbr);
int				minus_function(char **new_nbr, t_options *op, int ret);

int				print_char(int c, t_options *op);
int				nbr_make_str(unsigned long long nbr,
				char **new_nbr, t_options *op);
...
void			m_s(unsigned long long nbr,
				t_options *op, int ret, char ****new_nbr);
